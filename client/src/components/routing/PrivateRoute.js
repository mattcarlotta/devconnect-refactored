...
const PrivateRoute = ({
  ...
  <Route
    ...
    render={props =>
      ...
      ) : null // Not displaying anything because a loading spinner is shown when loading is true and profile is null (per logic in Dashboard component) and don't want to have multiple loading messages/spinners
    }
  />
);
